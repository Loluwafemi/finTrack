...
const MessageModal: React.FC<MessageModalProps> = ({ visible, onClose, userDetails }) => {
  const { isDarkColorScheme } = useColorScheme();
  const currentColors = isDarkColorScheme
    ? {
        background: "#18181B",
        card: "#27272A",
        border: "#3F3F46",
        ...
        >
          ...
          <View className="flex-1 p-4">
            <View className="flex-1 flex-row" style={{ gap: 16 }}>
              ...
              {/* Right Section - Message Content Placeholder */}
